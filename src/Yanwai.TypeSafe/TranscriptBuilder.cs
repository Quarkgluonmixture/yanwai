...
/// <paramref name="IsVerified"/> is false for text that is usable but that the OCR
/// cross-check could not confirm; it is counted, not dropped.
/// </summary>
...
public sealed record TranscriptBuildResult(string Transcript, int SkippedUntrusted, int UnverifiedCount = 0);
